 ...
 *
 * Структурные ограничения на текст письма и единственность ссылки уменьшают ложные
 * срабатывания на цитаты и пересылки. Доверенный origin проверяется только у ссылки;
 * отправитель письма здесь не аутентифицируется.
 */
